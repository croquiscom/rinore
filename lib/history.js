...
function setupHistory(replServer, historyFile, historySize) {
    ...
    if (historyFile.startsWith('.rinore/')) {
        ...
        if (fs_1.default.existsSync(path_1.default.join(os_1.default.homedir(), historyFile)) && !fs_1.default.existsSync(path_1.default.join(os_1.default.homedir(), newHistoryFile))) {
