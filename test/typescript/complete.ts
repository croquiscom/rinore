import rinore_context from '../../src/context.cjs';
import { testCompleteTypescript as testComplete } from '../util.js';
  ...
  describe('complete', () => {
    ...
    describe.skip('function argument', () => {
      describe('by ways to define function', () => {
        ...
        it('JavaScript function declaration', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/js_func_decl:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('JavaScript function expression', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/js_func_expr:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('JavaScript arrow function', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/js_func_arrow:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('CoffeeScript function', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/coffee_func:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('TypeScript function declaration', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/ts_func_decl:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('TypeScript function expression', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/ts_func_expr:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('TypeScript arrow function', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/ts_func_arrow:*`], { silent: true });
          const runList: string[] = [];
        ...
        it('TypeScript class method', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/ts_class_method:*`], { silent: true });
      ...
      describe('various situation', () => {
        ...
        it('with open parentheses', async () => {
          await rinore_context.loadModules([`${__dirname}/../samples/js_func_decl:*`], { silent: true });
          const runList: string[] = [];
          const code = 'funcJsDecl(';
          const expectedResult: [string[], string] = [['funcJsDecl'], 'funcJsDecl'];
